...
const PROVIDERS: Record<string, OAuthProvider> = {
  ...
  microsoft: {
    // Microsoft identity platform (Graph): Outlook, OneDrive, Teams, Calendar.
  ...
  "google drive": { ...GOOGLE, scopes: ["https://www.googleapis.com/auth/drive"] },
  "google sheets": { ...GOOGLE, scopes: ["https://www.googleapis.com/auth/spreadsheets"] },
};
